...
Define the default `/list` daily triage behavior for local Todo reminders and WorkItems, including grouping, ordering, risk reasons, stale markers, and compatibility with existing detailed list filters.
