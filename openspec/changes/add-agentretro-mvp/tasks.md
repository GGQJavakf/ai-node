...
- [x] 2.10 Add tests whose names or metadata reference every Codex retrospective scenario `CR-01` through `CR-22`, and record the scenario-to-test mapping in verification evidence.
...
- [x] 3.11 Add tests whose names or metadata reference every knowledge-review scenario `KR-01` through `KR-24`, and record the scenario-to-test mapping in verification evidence.
...
- [x] 5.8 Add tests whose names or metadata reference every briefing and integration scenario `BR-01` through `BR-28`, and record the scenario-to-test mapping in verification evidence.
